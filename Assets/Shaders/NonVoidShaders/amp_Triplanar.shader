...
Shader "amp_Triplanar"
{
	Properties
	{
		...
		_EdgeColor("EdgeColor", Color) = (0.1445799,0.1792453,0.1506974,1)
		_EdgeWidth("Edge Width", Range( 0 , 1)) = 1
		_TopSpread("TopSpread", Range( 0.05 , 4)) = 0.3629656
		_DecayingAmplitude("Decaying Amplitude", Range( 0.1 , 0.9)) = 0.5109177
	...
	SubShader
	{
		...
		uniform float _DecayingAmplitude;
		...
		{
			float temp_output_169_0 = ( ( _SinTime.z * _DecayingAmplitude ) + 0.25 );
			float temp_output_164_0 = ( ( _TopSpread + _EdgeWidth ) * temp_output_169_0 );
...
/*ASEBEGIN
Version=18712
331;1484;1880;884;822.8537;1621.436;1.545492;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;167;184.2013,-728.2429;Inherit;False;Property;_DecayingAmplitude;Decaying Amplitude;13;0;Create;True;0;0;0;False;0;False;0.5109177;0.9;0.1;0.9;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;170;512.1768,-499.0663;Inherit;False;Constant;_Float1;Float 1;14;0;Create;True;0;0;0;False;0;False;0.25;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;108;276.3913,-1116.631;Inherit;False;Property;_EdgeWidth;Edge Width;9;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;168;468.263,-725.4696;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;169;668.7812,-727.015;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;146;1471.419,-1357.85;Inherit;False;Property;_EdgeColor;EdgeColor;8;0;Create;True;0;0;0;False;0;False;0.1445799,0.1792453,0.1506974,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;166;200.4927,-824.3273;Inherit;False;Property;_DecayingMin;DecayingMin;12;0;Create;True;0;0;0;False;0;False;0.1;0;0.1;0.9;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=96621AB2FDDF37ED3DBFBC5A47D879DB03D6A183