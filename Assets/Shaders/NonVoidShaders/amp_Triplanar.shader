...
Shader "amp_Triplanar"
{
	...
	SubShader
	{
		...
		{
			float temp_output_129_0 = ( _TopSpread + _EdgeWidth );
			...
			float4 temp_output_96_0 = ( ( tex2D( _Noise, ( appendResult15 * _NoiseTextureScale ).xy ) * temp_output_83_0 ) + ( ( tex2D( _Noise, ( appendResult17 * _NoiseTextureScale ).xy ) * temp_output_85_0 ) + ( tex2D( _Noise, ( appendResult18 * _NoiseTextureScale ).xy ) * temp_output_72_0 ) ) );
			float dotResult117 = dot( temp_cast_0 , ( float4( ase_vertexNormal , 0.0 ) + ( ( temp_output_96_0 * 0.5 ) + temp_output_96_0.g ) ) );
			o.Albedo = ( ( ( _TopColor * ( step( temp_output_129_0 , dotResult117 ) * ( ( tex2D( _TopTexture, ( appendResult15 * _TopTextureScale ).xy ) * temp_output_83_0 ) + ( ( tex2D( _TopTexture, ( appendResult17 * _TopTextureScale ).xy ) * temp_output_85_0 ) + ( tex2D( _TopTexture, ( appendResult18 * _TopTextureScale ).xy ) * temp_output_72_0 ) ) ) ) ) + ( _EdgeColor * ( step( _TopSpread , dotResult117 ) * step( dotResult117 , temp_output_129_0 ) ) ) ) + ( _SideColor * ( ( ( tex2D( _SideTexture, ( appendResult15 * _SideTextureScale ).xy ) * temp_output_83_0 ) + ( ( tex2D( _SideTexture, ( appendResult17 * _SideTextureScale ).xy ) * temp_output_85_0 ) + ( tex2D( _SideTexture, ( appendResult18 * _SideTextureScale ).xy ) * temp_output_72_0 ) ) ) * step( dotResult117 , _TopSpread ) ) ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18712
330;1498;1880;870;6033.389;3217.622;5.94332;True;True
...
Node;AmplifyShaderEditor.WorldPosInputsNode;11;-3356.398,-1312.987;Inherit;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;150;-2599.716,-1351.59;Inherit;False;Property;_NoiseTextureScale;NoiseTextureScale;7;0;Create;True;0;0;0;False;0;False;0.6033961;0.1;-10;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;18;-3071.396,-853.6871;Inherit;True;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.DynamicAppendNode;17;-3074.252,-1191.196;Inherit;True;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;152;-2261.694,-892.0274;Inherit;True;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;151;-2263.758,-1130.433;Inherit;True;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;15;-3063.078,-1515.41;Inherit;True;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;149;-2264.429,-1352.955;Inherit;True;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.CommentaryNode;123;-488.3174,-1005.639;Inherit;False;691.6182;526.6148;(noisetexture.y + (noisetexture * 0.5));4;114;113;109;110;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;110;-438.3175,-834.951;Inherit;False;Constant;_Float0;Float 0;9;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;114;-271.7445,-733.0237;Inherit;True;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.CommentaryNode;128;-485.1594,-1574.24;Inherit;False;781.9852;548.5261;worldNormalDotNoise;5;118;116;115;117;135;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;109;-282.5701,-955.6387;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;113;-31.70032,-863.9387;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.NormalVertexDataNode;115;-435.1592,-1243.316;Inherit;True;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldNormalVector;118;-436.6386,-1505.053;Inherit;True;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SaturateNode;135;-165.6213,-1496.845;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;108;397.2643,-1105.205;Inherit;False;Property;_EdgeWidth;Edge Width;9;0;Create;True;0;0;0;False;0;False;0.1792134;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;107;393.6144,-1240.632;Inherit;False;Property;_TopSpread;TopSpread;10;0;Create;True;0;0;0;False;0;False;0.3629656;0;0.05;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;116;-182.85,-1266.939;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.DotProductOpNode;117;51.02427,-1459.748;Inherit;True;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;129;682.6804,-1185.875;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StepOpNode;144;906.1049,-1127.188;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;134;851.2781,-1776.876;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;143;903.8046,-1359.823;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;136;1066.61,-1777.571;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;145;1142.719,-1142.514;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;146;1135.778,-1363.58;Inherit;False;Property;_EdgeColor;EdgeColor;8;0;Create;True;0;0;0;False;0;False;0.1886348,0.254717,0.1988013,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;138;1064.297,-1961.406;Inherit;False;Property;_TopColor;TopColor;1;0;Create;True;0;0;0;False;0;False;0.5475008,0.8679245,0.3807404,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StepOpNode;130;809.395,-518.9005;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;139;1311.095,-1800.082;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;147;1377.521,-1244.39;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;131;1034.043,-517.4155;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;140;1002.38,-726.7448;Inherit;False;Property;_SideColor;SideColor;4;0;Create;True;0;0;0;False;0;False;0.1561944,0.2225333,0.2830189,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;137;1609.148,-1266.855;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;141;1256.479,-549.6722;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;90;2156.645,-1038.527;Inherit;False;Property;_Specular;Specular;11;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;148;1919.097,-1161.76;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2337.079,-1163.316;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;amp_Triplanar;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;0;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=8FDC5A77D04A35BB054DB7441323872B9B1F5DDE