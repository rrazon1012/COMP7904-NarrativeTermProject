Shader "Toon/Lit Tri Planar Normal" {
    Properties{
        ...
        _SideColor("Side/Bottom Color", Color) = (0.5,0.5,0.5,1)
        ...
        _TopSpread("TopSpread", Range(-2,4)) = 1
...
#pragma lighting ToonRamp exclude_path:prepass
    ...
    float4 _TopColor, _SideColor, _RimColor, _RimColor2, _EdgeColor;
    float _RimPower;
    ...
    void surf(Input IN, inout SurfaceOutput o) {
        ...
        // final albedo color
        o.Albedo = (topTextureResult * _TopColor) + (sideTextureResult * _SideColor) + (topTextureEdgeResult * _TopColor);
